                 ...
                 <div class="card h-100">
                     ...
                     <div class="d-flex flex-row-reverse bd-highlight">
                         <div class="p-2 pr-4 bd-highlight">
                             <button class="btn btn-primary" data-toggle="modal" data-target="#modalTambahDownstream">Tambah Laporan Downstream</button>
         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <div class="table-responsive">
                     <form action="<?= base_url('add_data_downstream') ?>" method="POST">
                         <div class="row">
                             <div class="col-lg-12">
     ...
     $(function() {
         ...
         $("#add-form-pelaporan").on('click', function() {
             ...
             if (value) {
                 ...
                 html += `<h3>FORM Pendaftaran Laporan downstream</h3>`;
                 html += `
                    <tr>
