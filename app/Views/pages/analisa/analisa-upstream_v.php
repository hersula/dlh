                 ...
                 <div class="card h-100">
                     ...
                     <div class="d-flex flex-row-reverse bd-highlight">
                         <div class="p-2 pr-4 bd-highlight">
                             <button class="btn btn-primary" data-toggle="modal" data-target="#modalTambahUpstream">Tambah Laporan Upstream</button>
         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <div class="table-responsive">
                     <form action="<?= base_url('add_data_upstream') ?>" method="POST">
                         <div class="row">
                             <div class="col-lg-12">
     ...
     $(function() {
             ...
             $.ajax({
                 ...
                 success: function(data) {
                     ...
                     for (let i = 0; i < data.length; i++) {
                        ...
                        <td>
                            <input type="text" class="form-control" name="parameter_val[]" required >
                            <input type="hidden" name="parameter[]" value="${data[i]['parameter']}" />
                        </td>
                        </tr>
                        `;
                     }
         ...
         $("#add-form-pelaporan").on('click', function() {
             ...
             if (value) {
                 ...
                 html += `<h3>FORM Pendaftaran Laporan Upstream</h3>`;
                 html += `
                    <tr>
