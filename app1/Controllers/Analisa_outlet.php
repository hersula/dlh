...
class Analisa_outlet extends BaseController
{
    ...
    public function insert_outlet()
    {
        ...
        // Success!
        return redirect()->route('analisa-outlet')->with('message', 'Tambah Pelaporan Outlet Berhasil');
    }
    ...
    public function get_datatable_data_outlet()
    {
        ...
        if ($this->request->isAJAX()) {
            ...
            $query      = $db->query("SELECT outlet_id, type_report.name as tipe_pelaporan,outlet_hd.tgl_pelaporan, 
                            outlet_hd.tgl_start_sampling,outlet_hd.tgl_end_sampling, 
