             ...
             <div class="col-lg-12">
                 <div class="card h-100">
                     ...
                     <div class="card-header">
                         <h3 class="mb-0">Data Peringatan Industri Baku Mutu Lingkungan (BML)</h3>
                         <p class="text-sm mb-0">
                             Halaman ini untuk melihat peringatan batas akhir baku mutu lingkungan dari industri yang terdaftar dan tervalidasi.
                         </p>
                         ...
                         <table class="table table-flush" id="datatable-data-harian">
                             <thead class="thead-light">
                                 <tr>
                                     ...
                                     <th>Tanggal Data</th>
                                     <th>Nama Industri</th>
                                     <th>Parameter Yang Tidak Sesuai BML</th>
                                     <th>Pesan</th>
                                 </tr>
                             </thead>
                             <tbody>
                                 <tr>
                                     ...
                                     <td>2011/03/31</td>
                                     <td>PT INDUSTRI A</td>
                                     <td><label class="badge badge-danger">pH</label></td>
                                     <td><label class="badge badge-danger">Parameter pH Melebihi Baku Mutu Lingkungan</label></td>
                                 </tr>
                                 <tr>
                                     <td>2</td>
                                     <td>Q1</td>
                                     <td>2011/03/31</td>
                                     <td>PT INDUSTRI A</td>
                                     <td><label class="badge badge-danger">COD</label></td>
                                     <td><label class="badge badge-danger">Parameter COD Melebihi Baku Mutu Lingkungan</label></td>
                                 </tr>
                                 <tr>
                                     <td>3</td>
                                     <td>Q1</td>
